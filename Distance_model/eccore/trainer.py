...
import torch
from eccore import checkpoint_utils, models, optim, utils
from eccore.distributed import utils as distributed_utils
from eccore.logging import meters, metrics
from eccore.nan_detector import NanDetector
from eccore.optim import lr_scheduler
from eccore.ema import ExponentialMovingAverageModel
...
class Trainer(object):
    ...
    def get_train_iterator(
        ...
        ##print('len(new_dataset):', len(new_dataset)) #16496
        ##print('self.args.train_subset:', self.args.train_subset) #train
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        try:
            ...
            with torch.autograd.profiler.record_function("clip-grads"):
                # clip grads
                #print('self.args.clip_norm:', self.args.clip_norm)
                grad_norm = self.clip_grad_norm(self.args.clip_norm)
                #grad_norm = self.clip_grad_norm(2) #None
