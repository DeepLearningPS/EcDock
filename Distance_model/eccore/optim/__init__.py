...
from eccore import registry
from eccore.optim.unicore_optimizer import (  # noqa
    UnicoreOptimizer,
)
from eccore.optim.fp16_optimizer import FP16Optimizer
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith(".py") and not file.startswith("_"):
        ...
        importlib.import_module("eccore.optim." + file_name)
