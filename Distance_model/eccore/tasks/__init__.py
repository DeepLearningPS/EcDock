...
def register_task(name):
    ...
    :func:`~eccore.tasks.register_task` function decorator.
    ...
    .. note::
        ...
        All Tasks must implement the :class:`~eccore.tasks.UnicoreTask`
        interface.
...
for file in os.listdir(tasks_dir):
    ...
    if (
        ...
        module = importlib.import_module("eccore.tasks." + task_name)
