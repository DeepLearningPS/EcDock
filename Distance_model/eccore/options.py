...
def parse_args_and_arch(
    ...
    from eccore.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    if hasattr(args, "task"):
        from eccore.tasks import TASK_REGISTRY

        TASK_REGISTRY[args.task].add_args(parser)

    # Add *-specific args to parser.
    from eccore.registry import REGISTRIES
...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--train_path', default="./premodel/unimol_docking_v2_240517.pt", type=str,
                        help=" ")
    # fmt: on
    return group
...
def add_model_args(parser):
    ...
    from eccore.models import ARCH_MODEL_REGISTRY
