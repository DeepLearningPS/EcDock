...
from eccore.data import iterators
from eccore.distributed import utils as distributed_utils
from eccore.logging import meters, metrics, progress_bar
from eccore.trainer import Trainer
from multiprocessing.pool import ThreadPool

from eccore.data.nested_dictionary_dataset import  BuildDataset
def pre_data(dataset):
    #，None
    count = 0
    new_dataset = []
    for ddt in dataset: 
...
def main(args) -> None:
    ...
    #print('args.valid_subset.split(","):', args.valid_subset.split(",")) #args.valid_subset.split(","): ['valid']
    #for valid_sub_split in args.valid_subset.split(","):
        #task.load_dataset(valid_sub_split, combine=False, epoch=1)
        #dataset = task.dataset(valid_sub_split)
        #dataset = pre_data(dataset)
...
def train(
    ...
    #print('len(progress):', len(itr)) # 1912 = 1912 * 10 = 19120
    ...
    args.save_interval_updates  = 1000
    args.validate_after_updates = 1000
    ...
    for i, samples in enumerate(progress):
        ...
        #print('args.save_interval_updates:', args.save_interval_updates) #0
        #print('args.validate_after_updates:', args.validate_after_updates) #0
...
def cli_main(
    ...
    args = options.parse_args_and_arch(parser, modify_parser=modify_parser) #，，modify_parser
