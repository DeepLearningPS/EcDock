...
if __name__ == '__main__':
    ...
    for step in [1, 5, 10, 15, 25, 50][4:5]: #，？
        ...
        main(f'../EcDock_sample_dir/{args.data_name}_ecdock_{args.diffusion}_{args.gnn}_step{step}_{GP.interaction_stype}_limit{GP.cross_distance_cutoff}ai_{args.test_name}', data_flag, sample_num, data_path, data_split, data_name, args)
    ...
    for step in [1, 5, 10, 15, 25, 50][4:5]:
        ...
        if model == 'ecdock':    #posebusters_ecdock_cm_equiformer_step1
            file_path = f'../EcDock_sample_dir/{args.data_name}_ecdock_{args.diffusion}_{args.gnn}_step{step}_{GP.interaction_stype}_limit{GP.cross_distance_cutoff}ai_{args.test_name}' #，sdfpickle，
