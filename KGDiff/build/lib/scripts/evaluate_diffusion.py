...
def main():
    ...
    parser.add_argument('--protein_root', type=str, default='../CrossDocked2020/data/test_set/')#
    ...
    for example_idx, r_name in enumerate(tqdm(results_fn_list, desc='Eval')):
        ...
        for sample_idx, (pred_pos, pred_v, pred_exp_score, pred_exp_atom_weight) in enumerate(zip(all_pred_ligand_pos[:], all_pred_ligand_v[:], all_pred_exp_score[:], all_pred_exp_atom_traj[:])):
            ...
            #print('pred_atom_type:', pred_atom_type) #
            #exit()
            ...
            #smiles，try，Explicit valence for atom # 6 N, 4, is greater than permitted
            #N3，4，rdkit
            try:
    ...
    #print('success_atom_types:', success_atom_types) #
