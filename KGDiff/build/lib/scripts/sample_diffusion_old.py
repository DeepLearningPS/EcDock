...
def sample_diffusion_ligand(model, data, num_samples, batch_size=16, device='cuda',
    ...
    all_pred_pos_traj, all_pred_v_traj, all_pred_exp_traj, all_pred_exp_atom_traj = [], [], [], [] #，*traj？
    ...
    for i in tqdm(range(num_batch)):
        ...
        with torch.no_grad():
            ...
            #org_ligand_pos = org_ligand_pos + torch.randn_like(batch_center_pos) #
...
def main():
    ...
    for i in list(range(91))[3:5]:
        ...
        #rdkit3DKNN
        # 
        mol = generate_3d_conformer_from_smiles(data.ligand_smiles) #mmft，mol
        ...
        shutil.copytree(source_dir, target_dir, dirs_exist_ok=True) #，,dirs_exist_ok=True
