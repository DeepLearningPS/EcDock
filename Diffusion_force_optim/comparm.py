...
class GPARMAS:
    def __init__(self):
        ...
        self.num_degrees=2
        self.depth=6
        self.consistency_training_steps=5 #
        ...
        self.force_loss = 1 #, 1
        self.loop       = 1 #,LBFGS 1
        self.mmf_method_mode = 'ecdock' # 'xu'/karmadock, xummf，，，，rdkit
        ...
        self.cross_distance_num = 'best' #

        self.single_cross_distance_id = None #0，，，，None，，，id，5

        
        self.data_type = 'VSDS_Glide_refine_fail_dataset' #，CrossDocked2020DEKOIS2.0VSDS_DTEBV-D(), VSDS_Glide_refine_fail_dataset 
        #
