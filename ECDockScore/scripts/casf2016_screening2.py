...
if args['device'] == 'cpu':
    results1 = Parallel(n_jobs=-1)(delayed(score_compound2)(pdbid, "v2020-refined", ligids, **args) for pdbid in ids1)
    results2 = Parallel(n_jobs=-1)(delayed(score_compound2)(pdbid, "v2020-other-PL", ligids, **args) for pdbid in ids2)
